...
func download(u *url.URL) {
	...
	//out, err := os.Create(OUT_PATH + fileName)
	out, err := os.OpenFile(OUT_PATH + fileName, os.O_CREATE|os.O_APPEND|os.O_WRONLY, 0600)
	if err != nil {
...
var OUT_PATH string = "test/"
//var IN_URL string = "http://rtmp.ottdemo.rrsat.com/rrsatlive4/rrsat4multi.smil/playlist.m3u8"

var IN_URL string = "https://cf-hls-media.sndcdn.com/playlist/yXNSseCCyDzJ.128.mp3/playlist.m3u8?Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiKjovL2NmLWhscy1tZWRpYS5zbmRjZG4uY29tL3BsYXlsaXN0L3lYTlNzZUNDeUR6Si4xMjgubXAzL3BsYXlsaXN0Lm0zdTgiLCJDb25kaXRpb24iOnsiRGF0ZUxlc3NUaGFuIjp7IkFXUzpFcG9jaFRpbWUiOjE2MDE4ODAzMDZ9fX1dfQ__&Signature=LHqiND1lePOUkpPUwTUVosnIpXNE0urp-dVupVhJ9lfs4OHjKhpjOxA~u5mwDcKO77SxgyTcn9KeWbIg4wM6gpwoeRlqrJIuBW7barVDqSHxbs5Rjx7qVKarzdIYf5WqoIMBY-172p-YpF3FueeeTRT04DN1LB6bAUDtvehQB-GBHm--l1SXIdP7YtLjKudNVVbxthTta8A9Dc3J0jk4~EB5434gvjN2Q31YFMu2RdPlZa-bhVRrE5szobKooC0W0Lfq4EwIzjYNMD34QIQ~SYY1d4MhVyYkKpYAL9Q9yPV8g5cHuo3ntpNa8MulCrdEGV8rWY9b23gCu0eqibxDAQ__&Key-Pair-Id=APKAI6TU7MMXM5DG6EPQ"
